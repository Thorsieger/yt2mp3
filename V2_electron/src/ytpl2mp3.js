...
document.getElementById('btnParams').addEventListener('click', function () {
  document.getElementById('paramModal').classList.add('visible')
});

document.getElementById('closeParams').onclick = function () {
  document.getElementById('paramModal').classList.remove('visible')
}
